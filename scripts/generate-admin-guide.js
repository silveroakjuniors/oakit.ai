/**
 * Generate Admin Guide PDF from HTML template using Puppeteer
 *
 * Usage: node scripts/generate-admin-guide.js
 * Output: admin-guide.pdf (in oakit root)
 */
...
const TEMPLATE = path.join(__dirname, 'admin-guide-template.html');
const OUTPUT = path.join(__dirname, '..', 'admin-guide.pdf');
