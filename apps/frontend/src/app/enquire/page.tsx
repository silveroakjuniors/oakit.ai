      ...
      <div className="w-full sm:max-w-sm bg-white rounded-t-3xl sm:rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="px-6 pt-5 pb-6">
          ...
          <h1 className="text-center text-xl font-bold text-gray-900 leading-snug mb-4">
            A Trusted School. More Than a School. A Start for Life.
          </h1>
          ...
          <p className="text-center text-xs text-gray-400 mt-3">⏱ Takes less than 2 minutes</p>
        </div>
      </div>
    </div>
  );
              ...
              <div className="text-center">
                <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-amber-500 via-amber-400 to-yellow-400 px-6 pt-8 pb-10 mb-5 shadow-xl shadow-amber-100">
                  ...
                  <h2 className="relative z-10 text-xl font-extrabold text-white leading-tight mb-2">
                    We already have your enquiry!
                  </h2>
                  <p className="relative z-10 text-white/90 text-sm leading-relaxed">
                    An open enquiry with this contact number already exists. Our admissions team will reach out to you shortly — no need to submit again.
                  </p>
                </div>

                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-4 mb-4">
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Need to reach us directly?</p>
                ...
                <button onClick={resetForm} className="w-full py-3 rounded-2xl font-medium text-sm border border-gray-200 text-gray-500 hover:bg-gray-50 transition-colors">
                  Submit with a different number
                </button>
              </div>
            ) : (
              /* Normal success */
