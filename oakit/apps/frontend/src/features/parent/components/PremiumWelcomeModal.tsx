...
const SLIDES = [
  ...
  },
  {
    ...
    headline: "Want it all? We've got you.",
    subline: "Public speaker. Story narrator. Exam champion. All 5 premium plans in one — the complete Oakit experience for your child's entire journey.",
    highlight: 'Everything · ₹3,500/year',
