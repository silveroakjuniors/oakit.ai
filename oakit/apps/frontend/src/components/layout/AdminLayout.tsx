...
const navItems = [
  ...
  { href: '/admin/finance/fee-structures',     label: 'Fee Structures',   icon: '🏷️', group: 'finance' },
  { href: '/admin/finance/fees',               label: 'Fee Collection',   icon: '💳',  group: 'finance' },
  { href: '/admin/finance/enquiries',          label: 'Admissions',       icon: '📝',  group: 'finance' },
  { href: '/admin/finance/expenses',           label: 'Expenses',         icon: '🧾',  group: 'finance' },
  { href: '/admin/finance/salary',             label: 'Salary',           icon: '👔',  group: 'finance' },
